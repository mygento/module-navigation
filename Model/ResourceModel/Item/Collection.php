...
namespace Mygento\Navigation\Model\ResourceModel\Item;
...
use Mygento\Navigation\Model\Item;
use Mygento\Navigation\Model\ResourceModel\Item as ItemResource;
use Psr\Log\LoggerInterface;

class Collection extends AbstractCollection
{
    /** @var string */
    protected $_idFieldName = ItemResource::TABLE_PRIMARY_KEY;
